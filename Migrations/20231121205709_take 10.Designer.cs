...
namespace Product_ReviewWebAPI.Migrations
{
    ...
    [Migration("20231121205709_take 10")]
    partial class take10
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Product_ReviewWebAPI.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Product_ReviewWebAPI.Models.Review", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Product_ReviewWebAPI.Models.Product", b =>
                {
                    b.HasOne("Product_ReviewWebAPI.Models.Review", "Review")
                        .WithMany()
            ...
            modelBuilder.Entity("Product_ReviewWebAPI.Models.Review", b =>
                {
                    b.HasOne("Product_ReviewWebAPI.Models.Product", "Product")
                        .WithMany()
